...
`grouping`               A drop down menu that gives you the option to name a 
                         ...
                         value of that factor. Also, the grouping coponent
...
This is it. Now we have a customized version of ExPanD focusing on communicating the robsutness of the Preston Curve. 
