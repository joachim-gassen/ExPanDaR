...
This is the documentation of the ExPanDaR (Explore Panel Data with R) package. I developed ExPanDaR to provide the code base for the ExPanD web app. ExPanD is a shiny based app supporting interactive exploratory data analysis.
