...
- Provide a toolbox for researchers to explore panel data on the fly, now also
...
Please note: The last parameter (`export_nb_option`) is currently only supported
by the development version of the package available on Github and has to be 
omitted when you use the CRAN version.
